...
public class TrackResource {
    ...
    public ResponseEntity<Track> createTrack(@Valid @RequestBody Track track) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/tracks/" + track.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME, track.getId()))
            .body(track);
    }
    ...
    public ResponseEntity<Track> updateTrack(
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, track.getId()))
            .body(track);
    }
    ...
    public ResponseEntity<Track> partialUpdateTrack(
        ...
        return ResponseUtil.wrapOrNotFound(result, HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, track.getId()));
    }
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<Track>> getAllTracks(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
     ...
     */
    @GetMapping("/{id}")
    public ResponseEntity<Track> getTrack(@PathVariable("id") String id) {
