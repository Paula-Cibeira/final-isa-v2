...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: 'e3ddeb11-f99a-4f89-bf3d-3ff8f3a0fc2b' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('1c8d3327-87d3-4206-ae25-17ec3cb671f9');
      cy.get(`[data-cy="name"]`).should('have.value', '1c8d3327-87d3-4206-ae25-17ec3cb671f9');
